      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {features.map((feature) => (
            <div
              key={feature.id}
              className="flex flex-col items-center text-center p-10 border border-[#EEEEEE] transition-all duration-300 hover:shadow-lg hover:border-primary/20 group"
            >
              {/* Icon Circle */}
              ...
              {/* Title */}
              <h3 className="text-xl font-bold italic text-[#1A1A1A] mb-4">
                {feature.title}
              </h3>
