            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-2 sm:gap-4">
                {documents.map((item) => (
                    <div key={item.name} className="rounded-md bg-white p-4">
                        <p className="mb-2 text-xl font-semibold text-secondary">{item.name}</p>
                        ...
                        <div className="flex items-center gap-2">
                            {item.href ? (
                                ...
                                <span className="flex-1 border text-center border-[#C8C8CA] bg-[#F1F1F2] px-3 py-2 text-base font-bold text-[#121E38]">
                                    VIEW
                                </span>
                            )}
                            {item.href ? (
                                <a
                                    ...
                                    className="grid h-10 w-20 place-items-center bg-[#C91E1E] text-white"
                                >
                                    <Download size={18} />
                                </a>
                            ) : (
