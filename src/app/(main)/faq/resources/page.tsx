...
export default function ResourcePage() {
    const { data, isLoading, isError } = useGetBlogListQuery({ category: 'resources' }) as {
        ...
        <main className="min-h-screen bg-slate-50/50 pt-28 pb-20 md:pt-32 lg:pt-36">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                ...
                <ReusableHeader
                    // badge=""
                    title="Resources"
                    description="Stay updated with the latest news, market insights, and EB-5 program updates from Winners Regional Center."
